...
function FAQ() {
    return(
        <div className='faq'>
            ...
            <h1 className='faq__h1'>
                Shop Terms & Conditions
            </h1>

            <div className='faq__container'>
                <div className='faq__container--main'>
                    <p className='faq__container--main_header'>
                        GENERAL TERMS AND CONDITIONS FOR SALE OF PRODUCTS AND SERVICES
                    </p>

                    <p className='faq__container--main_answers'>
                        ...
                        <br /> <br />
                        <b> Information on the Products supplied </b>
                        <br /> <br />
                ...
                <ul className='faq__container--catalog'>
                    <li className='faq__container--catalog_link'> Definitions & Interpretation </li>
                    <li className='faq__container--catalog_link'> General </li>
                    <li className='faq__container--catalog_link'> Quotations </li>
                    <li className='faq__container--catalog_link'> Prices / Taxes </li>
                    <li className='faq__container--catalog_link'> Terms of Payment </li>
                    <li className='faq__container--catalog_link'> Credit Accounts </li>
                    <li className='faq__container--catalog_link'> Change of Ownership </li>
                    <li className='faq__container--catalog_link'> Information on the Products supplied </li>
                    <li className='faq__container--catalog_link'> Delivery </li>
                </ul>
            </div>
